...
private static String productId;
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ProductDetailGui frame = new ProductDetailGui(productId);
    ...
    public ProductDetailGui(String productId) {
        ...
        productImage.setBounds(39, 162, 150, 117);
        contentPane.add(productImage);  // Adding the button to the content pane
